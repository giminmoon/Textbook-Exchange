		...
		<div id="menuBar">
			<ul>
				...
				<li class="dropDown"><a href="javascript:void(0)"
					class="dropButton"><%=session.getAttribute("email") %></a>
				...
				<%
					...
					%>
				<li><form name="loginform" action="Login.jsp" method="POST">
						<button type="submit">Log in</button>
					</form></li>
				<li><form name="signupform" action="Signup.jsp" method="POST">
						<button type="submit">Sign up</button>
					</form></li>

				<%
					} else {%>
				<li><form name="logoutform" action="logout" method="POST">
				...
				<%
					...
					%>
				<li><form name="home" action="home.jsp" method="POST">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-3 col-lg-3 " align="center">
						<img alt="User Pic" src="images/NewBook.png"
					...
					<div class=" col-md-9 col-lg-9 ">
						...
						<table class="table table-user-information">
							<tbody>
								<tr>
									<td>Title</td>
									<td><input id="inputprice" type="text"
										placeholder="Enter Title" name="title" required></a></td>
								</tr>
								
								<tr>
									<td>Author</td>
									<td><input id="inputprice" type="text"
										placeholder="Enter Author" name="author" required></a></td>
								</tr>
								<tr>
									<td>ISBN</td>
									<td><input id="inputprice" type="text"
										placeholder="Enter ISBN" name="isbn" required></td>
								</tr>
								<tr>
									<td>Course:</td>
									<td><input id="inputprice" type="text"
										placeholder="Enter course" name="course" required></td>
								</tr>
							</tbody>
						</table>
