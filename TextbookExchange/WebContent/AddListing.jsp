			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-3 col-lg-3 " align="center">
						<img alt="User Pic" src="<%=textbook.image%>"
							class="img-responsive">
					</div>
					<div class=" col-md-9 col-lg-9 ">
						<form id="addListing" action="addListing" method="POST">
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										<td>Condition:</td>
										<td><input type="text" placeholder="Enter condition" name="condition" required></td>
									</tr>
									<tr>
										<td>Price:</td>
										<td>$<input id="inputprice" type="text" placeholder="Enter price" name="price" required></td>
									</tr>
								</tbody>
							</table>
						 ...
						 <a href="BookListing.jsp" class="btn btn-primary">Back</a>
					</div>
				</div>
			</div>
		</div>
