...
<html>
	...
	ResultSet rs = st.executeQuery("SELECT * FROM Listing WHERE userID='" + (int)session.getAttribute("userID")+ "'");
	...
	<div class="panel panel-info">
		...
		<h3 class="panel-title">My Listing</h3>
		</div>
				...
				<div class=" col-md-9 col-lg-9 "> 
					<table class="table">
						...
						<%	
							...
							ResultSet rs1 = st1.executeQuery("SELECT * FROM Book WHERE bookID='" + bookID + "'");
							rs1.next();
						...
						%>	
							...
							<td><form name="deleteform" action="deletepost" method="GET"><button type="submit" name="submit" value="<%=rs.getInt("listingID") %>">Remove</button></form></td>	
			    			</tr>
			    			<% 
			    			}
			 			%>
